                ...
                ?>
										...
										<form class="form" action="" method="post">
											<div class="form-group row">
												...
												<div class="col-md-9">
													<input type="text" name="name" value="<?php echo $check['name'];?>" class="form-control" required>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Last Name</label>
												<div class="col-md-9">
													<input class="form-control" value="<?php echo $check['l_name'];?>"type="text" name="l_name" required>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Email</label>
												<div class="col-md-9">
													<input class="form-control" value="<?php echo $check['email'];?>" type="email" name="email" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Mobile No.</label>
												<div class="col-md-9">
													<input type="number" value="<?php echo $check['mobile'];?>" name="mobile" class="form-control" required>
												</div>
											</div>
												<div class="form-group row">
												<label class="col-md-3 col-form-label">Date Of Birth</label>
												<div class="col-md-9">
													<input type="date" name="bday" value="<?php echo $check['dob'];?>"  class="form-control" >
												</div>
											</div>
											<div class="form-group row">
												<label class="col-md-3 col-form-label">Enter Your ID</label>
												<div class="col-md-9">
													<input type="text" name="ID" value="<?php echo $check['user_id'];?>"  class="form-control" >
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="address" value="<?php echo $check['address'];?>" name="address"  class="form-control" >
												</div>
												<div class="col-md-4">
											...
											<div class="form-group row">
												...
												<div class="col-md-9">
													<select value="<?php echo $check['sel_op'];?>" name="sel_op" class="custom-select form-control">
                    ...
                    //print_r($mobile);die;
 $sql = "UPDATE forms SET name='$name', l_name='$l_name',dob='$dob',email='$email',address='$address', mobile='$mobile',pincode='$pin',sel_op='$sel_op',path='$location',status='update' WHERE id='$id'";
