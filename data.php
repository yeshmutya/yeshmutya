		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item"><a class="nav-link active" href="index.html"><em class="fa fa-dashboard"></em> Back to Website <span class="sr-only">(current)</span></a></li>
					<li class="nav-item"><a class="nav-link" href="forms.html"><em class="fa fa-pencil-square-o"></em> Forms <span class="sr-only">(current)</span></a></li>
				</ul>
			...
			<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
				...
				<section class="row">
					<div class="col-sm-12">
						...
						<section class="row">
							<div class="col-12 mt-1 mb-4">Design <a href="https://www.stalwartsoft.com">Stalwartsoft</a></div>
						</section>
					</div>
				</section>
			</main>
